...
class XBogus:
    ...
    def get_x_bogus(
        self, query: str, user_agent: str, params=8, test_time=None
    ):
        timestamp = int(test_time or time())
        query_array = self.process_url_path(query)
        return self.generate_x_bogus(query_array, params, user_agent, timestamp)
