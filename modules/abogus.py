...
class ABogus:
    ...
    def generate_string_1(
        cls, random_num_1=None, random_num_2=None, random_num_3=None
    ):
        return (
    ...
    def generate_string_2(
        ...
        a = self.generate_string_2_list(
            url_params, method, start_time, end_time
        )
    ...
    def get_value(self, url_params, method="GET", start_time=0, end_time=0, random_num_1=None, random_num_2=None, random_num_3=None) -> str:
